...
@include('sweet::alert')
<form action="{{url('/edit-kustomer')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
{{ csrf_field() }}
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" name="nama_kustomer" required="required" value="{{$kustomer->nama_kustomer}}">
              </div>
            </div>
            <div class="form-group">
              <label for="nama" class="col-sm-3 control-label">No. telp </label>
              <div class="col-sm-9">
                <input type="text" class="form-control" name="telp_kustomer" value="{{$kustomer->telp_kustomer}}">
              </div>
            </div>
            <div class="form-group">
              <label for="nama" class="col-sm-3 control-label">Alamat Kustomer <span class="required">*</span></label>
              <div class="col-sm-9">
                <textarea class="form-control" name="alamat_kustomer">{{$kustomer->alamat_kustomer}}</textarea>             
               </div>
            </div>
            </div>
        </div>
