...
<div class="box">
  <div class="box-body">
    <table id="table"
      ...
      <thead>
      <tr>
            <th data-field="pembelian_code">KODE</th>
            <th data-field="nama_suplier">SUPLIER</th>
            <th data-field="tgl_pembelian">TGL PEMBELIAN</th>
            <th data-field="total_harga" data-formatter="moneyFormatter">TOTAL PEMBELIAN</th>
      </tr>
      </thead>
    </table>
  </div>
         ...
         var $table = $('#table');
            ...
            function tableDetailFormatter(value, row) {
                ...
                $table.on('expand-row.bs.table', function (e, index, row, $detail) {
                    $detail.html('Loading...');
                    $.get( "{{url('/get-detail-pembelian')}}/" + row.id, function (res) {
                        console.log(res);
                            ...
                            columns: [
                                {
                                    ...
                                    field: 'harga_pembelian',
                                    title: 'HARGA PEMBELIAN',
                                    formatter: 'moneyFormatter'
                                },{
                                    field: 'harga_penjualan',
